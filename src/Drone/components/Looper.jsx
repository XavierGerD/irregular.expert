  ...
  render = () => {
    return (
      <div className="drone-container">
        ...
        <div className="instructions-narrow ">
          Start by adding events using the + sign. Select the note and its
          octave, as well as the number of beats it should be played before
          switching to the following event. Once all the events have played,
          they will be looped.
        </div>
        <div className="looper-container">
          <div className="control-container">
            ...
            >
              ...
              <div onClick={this.removeEvent} className="control-button">
                -
              </div>
            </div>
                  ...
                  <div style={{ display: "flex" }}>
                    ...
                    <div style={{ paddingLeft: "5px" }}>
                      <input
                        ...
                        className="rp-inputBox-small"
                        id={event.position}
                        onChange={(event) => this.handleBeatChange(event)}
                        value={event.beats}
                      />
                    </div>
                  </div>
