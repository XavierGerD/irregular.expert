    ...
    let ret = notes.map((note) => {
      if (note.color === "white") {
        ...
        return (
          <div
            className={className}
            onClick={(event) => this.setNote(event, note.frequency, note.pitch)}
          >
            <div>
              <div>{note.pitch}</div>
            </div>
      ...
      if (note.color === "black") {
        ...
        return (
          <React.Fragment>
            ...
            {note.pitch[0] === "E" ? <div className="notespacer"></div> : null}
            {note.pitch[0] === "B" ? <div className="notespacer"></div> : null}
          </React.Fragment>
        );
      }
    });
  ...
  render = () => {
    return (
      <div className="drone-container">
        ...
        <div className="instructions">
          Simply click on the note you choose. You can also change the octave.
        </div>
        <div className="drone-container">
          <div
            style={{
            ...
            <div className="select-container">
              ...
              <div className="cents-selector">
                ...
                <input
                  ...
                  onChange={(event) => this.setTuning(event.target.value)}
                />
              </div>
            </div>
            <Metronome />
